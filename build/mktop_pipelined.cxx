...
void MOD_mktop_pipelined::RL_requestMMIO()
{
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    if (DEF_rv_core_getMMIOReq_43_BITS_63_TO_32_46_EQ_0xF0_ETC___d154)
      dollar_fdisplay(sim_hdl, this, "32,32", 2147483650u, DEF__read__h3139);
...
unsigned int MOD_mktop_pipelined::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "_read__h3139", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mktop_pipelined::vcd_defs(tVCDDumpType dt, MOD_mktop_pipelined &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF__0_CONCAT_DONTCARE___d26 = DEF__0_CONCAT_DONTCARE___d26;
      ...
      ++num;
      if ((backing.DEF__read__h3139) != DEF__read__h3139)
      {
	vcd_write_val(sim_hdl, num, DEF__read__h3139, 32u);
	backing.DEF__read__h3139 = DEF__read__h3139;
      }
      ++num;
